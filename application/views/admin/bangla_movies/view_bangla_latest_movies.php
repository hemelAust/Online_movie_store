...
<table border="1" align="center" class="table_popular_bangla_movie">
    ...
    <tr>
        ...
        <td>
        	<a href="<?php echo base_url()?>super_admin/edit_bangla_latest_movie/<?php echo $row->l_id;?>" class="edit_">Edit</a> | 
            <a href="<?php echo base_url();?>super_admin/delete_bangla_latest_movie/<?php echo $row->l_id;?>" class="edit_" onclick="return checkDelete();">Delete</a>
        </td>
