...
<form method="post" action="<?php echo base_url();?>member/search_results_" >
  <input type="text" name="keyword" class="input_style_one"  placeholder="Search Old Bangla Movies"  size="40"  />
...
<a href="<?php echo base_url();?>member/view_bangla_old_movies" class="back"><input type="button" name="back" value="Back" class="back_" /> </a>
...
<form method="post" action="<?php echo base_url();?>view_controller/search_results_" >
  <input type="text" name="keyword" class="input_style_one"  placeholder="Search Old Bangla Movies"  size="40"  />
  <input type="submit" value="Search" class="search_button"/>
</form>
...
<a href="<?php echo base_url();?>view_controller/view_bangla_old_movies" class="back"><input type="button" name="back" value="Back" class="back_" /> </a>
<?php } ?>